            ...
            <div className="p-8 bg-linear-to-tl from-[#ecfdf5] to-[#f1fdfa] rounded-xl shadow">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                        ...
                        <div>
                            <h2 className="text-4xl font-bold py-2 max-w-[85%] lg:max-w-full">Get the Fresh Updates <span className="text-[#009966]">Free services</span></h2>
                            <p className="text-gray-500 font-semibold text-xl">Weekly updates, seasonal offers & exclusive member perks.</p>
                        </div>
