        ...
        <div className="container">
            <div className="grid grid-cols lg:grid-cols-2 gap-4 py-5 my-4">
                <div className="bg-linear-to-br from-[#00ba7b] to-[#007c56] px-5 rounded-lg text-white py-10 space-y-3 relative overflow-hidden">
                    <div className=" font-semibold bg-gray-50/90 text-gray-500 w-fit px-2 rounded-xl">
                        <FontAwesomeIcon icon={faFire} className="text-[#e7783c] w-4" />
                        <p>Deal of the Day</p>
                    </div>
                    <h2 className="text-4xl font-bold ">Over All Egypt</h2>
                    <p className="opacity-70 font-semibold text-lg">Get up to 40% off on selected </p>
                    <p ><span className="text-2xl font-bold inline-block pe-2">40% OFF</span><span className=" opacity-70"> Use code:</span> <span className="font-semibold inline-block ps-1">EGY12</span> </p>
                    <Link
                        href={''}
                ...
                <div className="bg-linear-to-br from-[#ff870f] to-[#ff2a54] px-5 rounded-lg text-white py-10 space-y-3 relative overflow-hidden">
                    <div className=" font-semibold bg-gray-50/90 text-gray-500 w-fit px-2 rounded-xl">
                        <FontAwesomeIcon icon={faFire} className="text-[#e7783c] w-4" />
                        <p>Deal of the Day</p>
                    </div>                    <h2 className="text-4xl font-bold ">Exotic Egypt</h2>
                    <p className="opacity-70 font-semibold text-lg">Discover our latest collection of premium Over</p>
                    <p ><span className="text-2xl font-bold inline-block pe-2">25% OFF</span><span className=" opacity-70"> Use code:</span> <span className="font-semibold inline-block ps-1">EXP125</span> </p>
                    <Link
                        href={''}
